...
# Function tests
print("Total sales of product_a:", funcs.total_sales_by_product(sales_data, "product_a"))
print("Average daily sales of product_b:", funcs.average_daily_sales(sales_data, "product_b"))
print("Day with highest total sales:", funcs.best_selling_day(sales_data))
print("Days when product_c exceeded 300 sales:", funcs.days_above_threshold(sales_data, "product_c", 300))
print("Product with highest total sales:", funcs.top_product(sales_data))